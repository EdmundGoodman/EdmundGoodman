  ...
  \resumeSubHeadingListStart
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Accepted to present a short-format talk derived from the dissertation as part of the \href{https://p3hpc.org/}{\underline{P3HPC}} workshop.}
      \resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
 \small{
   ...
   \item{
       \textbf{Technologies}
       {: Git, Kubernetes, Docker, TeamCity, GitLab CI, GNU Make, Cadence vManager, Cadence Indago, React, OpenMP, MPI, Slurm, Apache Hive, Apache HBase, PostgreSQL, Rocky Linux, EndeavourOS, Qt, Textual, Ruff, MyPy, FastAPI, Pydantic, \LaTeX, Markdown} \\
   }
  \vspace{-0.25em}
  \item{
