...
\begin{center}
    ...
    \href{mailto:hello@edmundgoodman.co.uk}{\underline{hello@edmundgoodman.co.uk}} $|$
  ...
  \resumeSubHeadingListStart
    \vspace{-2pt}\item
      \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
        ...
        \textit{\small{Advanced Computer Science MPhil; Distinction}} & \textit{\small{Cambridge, UK}} \\
    ...
    \vspace{-2pt}\item
      \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
        ...
        \textit{\small{A-levels in Maths, Further Maths, Physics \& Computer Science; Academic scholarship}} & \textit{\small{Cambridge, UK}} \\
      \end{tabular*}\vspace{-7pt}
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      {Master's Thesis}{Dec. 2024 -- Jun. 2025}
      \resumeItemListStart
        \resumeItem{Wrote a \href{https://github.com/EdmundGoodman/masters-project-report/releases/download/moodle-submission/edjg2-project-1.pdf}{\underline{dissertation}} titled ``Performance and Dynamism in User-extensible Compiler Infrastructures'', co-supervised by \href{https://www.lopoukhine.com/}{\underline{Sasha Lopoukhine}} and \href{https://grosser.science/}{\underline{Dr Tobias Grosser}}, achieving a Distinction grade of 83\%.}
        \resumeItem{Quantified and optimised the \href{https://github.com/xdslproject/xdsl}{\underline{xDSL compiler framework}}'s performance in comparison with MLIR, yielding a $10\times$ improvement and characterising the suitability of dynamic languages for performant compiler implementations.}
        \resumeItem{Built \href{https://github.com/EdmundGoodman/bytesight}{\underline{ByteSight}}, a novel performance profiler operating at the bytecode level for the CPython interpreter.}
        \resumeItem{Interest in performance results led to \href{https://github.com/python/pyperformance/pull/403}{\underline{merging benchmarks for xDSL}} into Python's official benchmarking suite.}
      \resumeItemListEnd
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Presented a short-format talk derived from the dissertation as part of the \href{https://p3hpc.org/workshop/2024/program/\#lightning-talks}{\underline{P3HPC workshop}}.}
      \resumeItemListEnd

    \resumeProjectHeading
      {MiniC Compiler}{Sept. -- Dec. 2023}
      \resumeItemListStart
