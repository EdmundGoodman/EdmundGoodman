...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      {Academic Coordinator $|$ University of Warwick Computing Society}{Sept. 2023 -- Jun. 2024}
      \resumeItemListStart
        \resumeItem{Organise and run academic events including technical and industry talks, introductory programming courses, workshops, and revision sessions, for example delivering a talk introducing \texttt{git} to new students.}
      \resumeItemListEnd

    \resumeProjectHeading
      {CAD Design Verification Intern $|$ Apple Inc.}{Jul. 2022 -- Jun. 2023}
      \resumeItemListStart
        \resumeItem{Intercalated year in industry from my degree at the UK Design Centre for Apple Silicon in St Albans.}
        \resumeItem{Built tools and infrastructure for the design and design verification of future Apple hardware.}
      \resumeItemListEnd

    \resumeProjectHeading
      {iGEM Team Member $|$ University of Warwick iGEM team}{Feb. 2021 -- Sept. 2021}
      \resumeItemListStart
        \resumeItem{Lead software for the international gold medal winning Warwick team for the iGEM synthetic biology competition.}
    ...
    \resumeProjectHeading
      {Software Engineering Intern $|$ HUBER+SUHNER Polatis}{Jul. 2020 -- Sept. 2020}
      \resumeItemListStart
        \resumeItem{Updated \texttt{python} for fibre-optic switch test harnesses; refactored \texttt{VBA} backend of a corporate planning spreadsheet.}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Co-founded and administrated an open source revision resource (\href{https://warwick.guide/}{\underline{warwick.guide/}}) for the first year Warwick computer science course, used by over 100 students, and with contributions from over 25.}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Lead the software aspect of the school ``Engineering Education Scheme'' entry, building an autonomous tennis ball collecting \href{https://drive.google.com/file/d/1t9qVtQVATlVSCroJkCgrlD1hFjH6NqUE/view}{\underline{robot}} to the help sports teachers. (\href{github.com/EdmundGoodman/EES}{\underline{https://github.com/EdmundGoodman/EES}})}
