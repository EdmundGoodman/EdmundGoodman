...
%       {HUBER+SUHNER Polatis $|$ Software Engineering Intern}{Jul. 2020 -- Sept. 2020}
%       \resumeItemListStart
%         \resumeItem{Resolved errors introduced by a major version bump of \texttt{python} for fibre-optic switch test harnesses; refactored \texttt{VBA} backend of a corporate planning spreadsheet.}
%       \resumeItemListEnd
